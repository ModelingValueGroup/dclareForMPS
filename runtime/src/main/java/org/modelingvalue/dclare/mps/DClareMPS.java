...
public class DClareMPS implements Universe, UncaughtExceptionHandler {
    ...
    public void init() {
        Universe.super.init();
        mpsTransaction = universeTransaction.addImperative("MPS", this::handleMPSDelta, this::invokeLater, false, true);
        ...
        for (INativeGroup ng : DRepository.ALL_NATIVE_GROUPS.get(getRepository())) {
            ...
            universeTransaction.addImperative(ng.getId(), this::handleNativeDelta, ng.getScheduler(this)::accept, false, false);
        }
