...
public class DclareForMpsConfig {
    ...
    protected DclareForMpsConfig create(DclareConfig config, EngineStatusHandler statusHandler, boolean onMode, boolean colorfulEditors, boolean showAspectRuleSetsInRulesTab, boolean dclareTrace, boolean dclareActivation, boolean traceMPSModelChanges, boolean disableAutoModelCheck, boolean autoMPSModelCheck, boolean remoteModelSynchronization, String remoteModelSynchronizationServer, String[] inactiveAspects) {
        return new DclareForMpsConfig(config, statusHandler, onMode, colorfulEditors, showAspectRuleSetsInRulesTab, dclareTrace, dclareActivation, traceMPSModelChanges, disableAutoModelCheck, autoMPSModelCheck, remoteModelSynchronization, remoteModelSynchronizationServer, inactiveAspects);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(config, statusHandler, onMode, colorfulEditors, showAspectRuleSetsInRulesTab, traceDclare, traceActivation, traceMPSModelChanges, disableAutoModelCheck, autoMPSModelCheck, remoteModelSynchronization, remoteModelSynchronizationServer, Arrays.hashCode(inactiveAspects));
    }
    ...
    public DclareForMpsConfig withDclareTrace(boolean dclareTrace) {
        return create(config, statusHandler, onMode, colorfulEditors, showAspectRuleSetsInRulesTab, dclareTrace, traceActivation, traceMPSModelChanges, disableAutoModelCheck, autoMPSModelCheck, remoteModelSynchronization, remoteModelSynchronizationServer, inactiveAspects);
    }

    public DclareForMpsConfig withDclareActivation(boolean dclareActivation) {
        return create(config, statusHandler, onMode, colorfulEditors, showAspectRuleSetsInRulesTab, traceDclare, dclareActivation, traceMPSModelChanges, disableAutoModelCheck, autoMPSModelCheck, remoteModelSynchronization, remoteModelSynchronizationServer, inactiveAspects);
    }
