...
public class MPSSerializationHelper implements SerializationHelper<DObjectType<DObject>, DObject, Setable<DObject, Object>> {
    ...
    public Predicate<Setable<DObject, ?>> setableFilter() {
        ...
        return m -> m instanceof Observed && m != (Object) DModule.LANGUAGES && m != (Object) DObject.D_PARENT_CONTAINING && m != (Object) DObject.CONTAINING_ATTRIBUTE && m != (Object) DNode.MODEL && m != (Object) DModel.MODEL_ROOT
